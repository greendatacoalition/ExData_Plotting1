...
par(mar=c(4,5,3,3))
with(hpcData, plot(dtime,Sub_metering_1, type="l", lwd=1, xlab="", ylab="Energy sub metering"))
with(hpcData, lines(dtime, Sub_metering_2, lwd= 1, col="blue"))
with(hpcData, lines(dtime, Sub_metering_3, lwd= 1, col="red"))
legend(
    "topright",
